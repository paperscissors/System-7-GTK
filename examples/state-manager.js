...
const StateManager = {
  ...
  loadState() {
    try {
      ...
      if (desktop) {
        ...
        const backgroundName = this.getBackgroundNameFromStyle(
  ...
  updateBackgroundMenuCheckmark(backgroundName) {
    const viewMenuItems = document.querySelectorAll(
      "#view-menu .dropdown-item",
    );
  ...
  updateSoundMenuCheck(enabled) {
    const menuItem = document.querySelector(
      '#apple-menu .dropdown-item:contains("Sound")',
    );
    if (menuItem) {
